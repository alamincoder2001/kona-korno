						...
						<div class="col-md-6 col-xs-12">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-3">
										<input type="number" step="0.01" id="quantity" min="0" name="quantity" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.pcs" v-on:input="productTotal" required />
									</div>
						...
						<div class="col-xs-12">
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<select class="form-control" style="padding: 0;" name="payment_type" id="payment_type" v-model="purchase.payment_type">
									...
									<tr v-if="purchase.payment_type == 'Bank'">
										<td>
											<div class="form-group">
	...
	new Vue({
		...
		methods: {
			...
			addToCart() {
				...
				if (parseFloat(product.purchaseRate) <= 0) {
			...
			savePurchase() {
				...
				if (this.purchase.payment_type == 'Bank' && this.selectedAcount.account_id == '') {
					alert("Select Bank Account");
					return
				}
				this.purchase.account_id = this.purchase.payment_type == 'Bank' ? this.selectedAcount.account_id : '';
