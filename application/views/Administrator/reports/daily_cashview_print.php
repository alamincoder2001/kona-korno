...
<body style="background:none;">
      ...
      <table width="800px" >
        ...
        <tr>
            <td colspan="2" style="background:#ddd;" align="center"><h2 >Daily Cash View</h2></td>
        </tr>
        <tr>
            <td>
            <!-- Page Body -->
              ...
              <table class="border" cellspacing="0" cellpadding="0" width="100%">
                ...
                <?php
                    ...
                    $sct = mysql_query("SELECT tbl_cashtransaction.*,tbl_account.* FROM tbl_cashtransaction left join tbl_account on tbl_account.Acc_SlNo=tbl_cashtransaction.Acc_SlID WHERE Tr_branchid = '$userBranch' AND Tr_date = CURDATE()");
                    $in="";$out="";
