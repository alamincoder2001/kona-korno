						...
						<tbody>
							<template v-for="sale in sales">
								...
								<tr>
									...
									<th style="text-align: right;">{{sale.products.reduce((ac, pr) => {return ac + +pr.quantity},0)}}</th>
									<th style="text-align: right;">{{sale.products.reduce((ac, pr) => {return ac + +pr.total_price},0).toFixed(2)}}</th>
								</tr>
							</template>
						</tbody>
